...
/*
 * Provides tasks for building and testing the jec-sokoke project.
 */
module.exports = function(grunt) {
  ...
  //--> Task: builds the "jec-sokoke" project:
  grunt.registerTask("build", ["ts:build", "copy:main",
                               "copy:initTypes", "copy:buildTypesFile",
                               "clean:build"]);

  //--> Task: builds the "jec-sokoke" API documentation:
